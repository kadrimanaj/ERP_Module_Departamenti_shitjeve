        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div>
                        <h5 class="card-title mb-0">Statistikat e Projekteve</h5>
                    </div>
                </div>
                <div class="card-body">
            ...
            $(document).on("click", ".delete-btn", function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('assets.destory', '') }}/" +
                            itemId, // Ensure this matches your route
                            type: "POST",
                            data: {
                                _token: "{{ csrf_token() }}",
                                _method: 'DELETE',
                            ...
                            success: function(response) {
                                Swal.fire("Deleted!", "The item has been deleted.",
                                    "success");
                                $("#model-datatables").DataTable().ajax
