...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                        <div class="col-3">
                            <h5 class="card-title mb-0">Lista e produkteve me formulare</h5>
                        </div>
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('departamentishitjes.modeles.create') }}" class="btn btn-sm btn-success">
                                + Shto Model
                            </a>
                        </div>
                </div>
    ...
    @include('departamentishitjes::modeles.editFormModal')
    ...
    $(function() {
        ...
        function initializeDataTable(itemId, itemName) {
            ...
            $('.model-datatables').DataTable({
                ...
                ordering: false,
                ajax: {
                    url: "{{ route('departamentishitjes.modeles.list') }}",
                    data: function (d) {
