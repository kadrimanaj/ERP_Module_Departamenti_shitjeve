        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <div>
                    ...
                    <button type="button" class="btn btn-danger btn-sm" id="confirmButton">
                        Mbyll
                    </button>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="staticBackdropLabel">Shto Elemente</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <input type="text" class="form-control" placeholder="Emri Produktit"><br>
                                    <input type="text" class="form-control" placeholder="Pershkrimi"><br>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-success">Shto</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="row mt-5">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <div>
                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#skiceModal">
                        + Shto skice
                    </button>
                            ...
                            <div class="modal-body">
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="skiceName" name="name" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control" id="skiceFile" name="file" accept="image/*" required>
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">
    ...
    <div class="col-12 mt-3 d-flex justify-content-center">
        <button class="btn btn-success">Shto</button>
    </div>
</div>
@section('js-script')
    ...
    document.getElementById('confirmButton').addEventListener('click', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // You can add further actions here, like submitting a form or redirecting.
