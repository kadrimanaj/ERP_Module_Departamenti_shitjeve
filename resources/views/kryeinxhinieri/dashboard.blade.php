...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-3">
            <div class="card filter-status" data-project_status="">
                <div class="card-body d-flex gap-3 align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="mb-0 text-muted">Preventivet e mia</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card filter-status" data-project_status="2">
                <div class="card-body d-flex gap-3 align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="mb-0 text-muted">Preventivet e Konfirmuara</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card filter-status" data-project_status="0">
                <div class="card-body d-flex gap-3 align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="mb-0 text-muted">Preventivet Pezull</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card filter-status" data-project_status="3">
                <div class="card-body d-flex gap-3 align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="mb-0 text-muted">Preventivet e Refuzuara</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="col-3">
                        <h5 class="card-title mb-0">Lista e Preventiveve</h5>
                    </div>
                </div>
                <div class="card-body">
                    {{-- <div class="row">
        ...
        $(function() {
            ...
            function initializeDataTable(itemId, itemName) {
                ...
                $('.model-datatables').DataTable({
                    ...
                    ordering: false,
                    ajax: {
                        url: "{{ route('kryeinxhinieri.projektet.list_dashboard') }}",
                        data: function(d) {
