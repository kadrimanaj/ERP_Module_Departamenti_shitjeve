    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4><a href="{{ route('departamentishitjes.kostoisti.dashboard') }}"><i class="ri-arrow-left-fill"></i>
                        Back</a></h4>
                        ...
                        <table id="model-datatables"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ _lang('Ngjyra') }}</th>
                                    <th>{{ _lang('Lenda e pare') }}</th>
                                    <th>{{ _lang('Lenda ndihmese') }}</th>
                                    <th>{{ _lang('Kosto te tjera') }}</th>
        ...
        $(function() {
            ...
            function initializeDataTable(itemId, itemName) {
                ...
                $('.model-datatables').DataTable({
                    ...
                    ordering: false,
                    ajax: {
                        url: "{{ route('kostoisti.preorder.list_preorder', ['id' => $id]) }}",
                        data: function(d) {
